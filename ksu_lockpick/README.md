...
- Supports multiple inventories with item name `lockpick`
- English locale with `locales` folder
...
3. Add `ensure fvm_lockpick` to your server config.
4. Make sure your lockpick item name is `lockpick`.
5. Change framework in `config.lua` if needed.
